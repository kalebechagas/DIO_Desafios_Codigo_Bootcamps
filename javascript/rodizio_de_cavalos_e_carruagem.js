...
while (numeroDaEntrada <= quantidadeDeEntradas) {
    ...
    const osTreprimeirosCaracteresSaoLetrasMaiusculas =
        ChecaSeTodosSaoLetrasMaiusculas(parteAlfabeticadaPlaca);
    const osQuatroUltimosCaracteresSaoNumeros =
        ChecaSeTodosSaoNumeros(parteNumericaDaPlaca);
